...
1. Generate 3-12 questions for this practice
...
Output questions as a YAML array:

```yaml
questions:
  - text: "Do you have documented deployment procedures?"
    polarity: positive
    guidance: "Check for runbooks or deployment documentation"
  - text: "Are there known security vulnerabilities in production?"
    polarity: negative
    guidance: "Review vulnerability scans and security reports"
    remediation: "Prioritize and address vulnerabilities based on severity"
  - text: "Is monitoring configured for all critical services?"
    polarity: positive
    evidence: "Dashboard showing service health metrics"
  - text: "Do you have rollback procedures documented?"
    polarity: positive
```
