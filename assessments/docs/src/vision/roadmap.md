...
- **Graceful LLM rate-limit / overload handling**
  ([#36](https://github.com/como-technologies/assessments/issues/36)) —
...
- **Shrink per-turn input tokens**
  ([#37](https://github.com/como-technologies/assessments/issues/37)) —
...
- **Suggested-reply pills**
  ([#38](https://github.com/como-technologies/assessments/issues/38)) —
...
- **PDF report generation**
  ([#2](https://github.com/como-technologies/assessments/issues/2)) —
...
- **Multi-choice / scale question kinds**
  ([#18](https://github.com/como-technologies/assessments/issues/18)) —
...
- **PDF vs. HTML vs. both for export?** Typst ([#2](https://github.com/como-technologies/assessments/issues/2))
